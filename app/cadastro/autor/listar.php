        ...
        <table class="w3-table-all w3-margin-top ">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>";
                    echo "<a href='/app/cadastro/autor/alterar.php?id=" . $row['id'] . "' class='w3-button w3-tiny w3-round w3-blue'>Alterar</a>";
                    echo "<a href='/app/cadastro/autor/excluir.php?id=" . $row['id'] . "' class='w3-button w3-tiny w3-round w3-red'>Excluir</a>";
                    echo "</td>";
                    echo "</tr>";
                }
            } else {
